                ...
                for (int x = 0; x < w; x++) {
                    ...
                    switch (mode) {
                        ...
                        case RING -> {
                            ...
                            char c = com.chihaya.moremultiblock.multiblock.MultiblockValidator
                        ...
                        case FRAME -> {
                            ...
                            int kind = com.chihaya.moremultiblock.multiblock.MultiblockValidator
                        ...
                        case SPHERE -> {
                            ...
                            if (corner || maxDist < half) {
                                cell = null;
                            } else if (com.chihaya.moremultiblock.multiblock.MultiblockValidator
